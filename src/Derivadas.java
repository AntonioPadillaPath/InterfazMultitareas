...
public class Derivadas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Valor del incremento:");
        ...
        Integral.setText("Ingresar función y realizar Incrementos");
        ...
        jLabel2.setText("Tabla de x y f(x):");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        AyudaDerivadas ader = new AyudaDerivadas();
        ader.setVisible(true);
    ...
    private void IntegralActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_IntegralActionPerformed
        ...
        try{
            ...
            for(k = a; k < b; k+= n)
            {
                ...
                for(j = grado; j>= 0;j--)
                {
                    funcion1 += (ecuacion[j] * (Math.pow(k, j)));
                    funcion2 += (ecuacion[j] * (Math.pow((k + n), j))); 
                }
                
                Ay = funcion2 - funcion1;
                Ax = (k + n) - k;
                
                Incremento = Ay / Ax;
                
                Resultado.append(funcion2+ " - " +funcion1+ " = " +Ay+ "\n");
                Resultado.append((k + n)+ " - " +k+ " = " +Ax+ "\n");
                
                Resultado.append("Incremento = ");
                Resultado.append(String.valueOf(Incremento));
                Resultado.append("\n");
                Resultado.append("\n");
